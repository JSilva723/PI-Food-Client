        ...
        {show === false
          ? <>
            <textarea placeholder=" Step to follow"
              type="text" className={s.textarea} ref={step}
            />
            <div className={s.list}>
              <input placeholder="Ingredient" type="text" className={s.input}
            ...
            <div className={s.list}>
              <input placeholder="Equipment" type="text" className={s.input}
